...
class OrderMenuAdapter(private val context: Activity, internal var foodList: List<Food>) :
    ArrayAdapter<Food>(context, R.layout.layout_order_food_list, foodList) {

    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val inflater = context.layoutInflater
        val listViewItem = inflater.inflate(R.layout.layout_order_food_list, null, true)
